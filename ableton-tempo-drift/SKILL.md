...
You analyze tempo and drift using the shared Ableton engine
(`ableton-shared`, a sibling skill).

## Tempo of one file
`<repo>/ableton-shared/bin/ableton tempo <FILE> [--hint-bpm N] --json`
...
`<repo>/ableton-shared/bin/ableton drift --master <MASTER> --stems <STEMS_DIR> --json`
